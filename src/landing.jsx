        ...
        <section id="landing">
            ...
            >
                ...
                <div className="relative z-10">
                    ...
                    <h1 className="text-6xl font-extrabold mb-4 font-[MedievalSharp] text-[#f4e1c1] drop-shadow-md mt-12">
                    ...
                    <a href="https://forms.gle/7418PyQ8kgsJa1Vc7" className="mt-2" target="_blank" rel="noopener noreferrer">
                        ...
                        bg-gradient-to-r from-[#A56A34] via-[#C19A6B] to-[#FFD700] hover:from-[#FFD700] hover:to-[#C19A6B] mt-10">
